...
class edit_review extends CI_Controller {
...
//      $this->bucket->set_data('id_get', $response['id_get']);
    ...
    function update_review($id) {
        ...
        $review->sending_date = $this->input->post('scheduled_date');
        $review->expiry_date = $this->input->post('expiry_date');
        $review->contact_number = $this->input->post('contact_number');
