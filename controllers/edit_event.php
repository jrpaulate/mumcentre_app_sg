...
//      $this->bucket->set_data('id_get', $response['id_get']);
    ...
    function update_event($id) {
        ...
        $event->body = $this->input->post('body');
        $event->venue = $this->input->post('venue');
        $event->cost = $this->input->post('cost');
        $event->contact_number = $this->input->post('contact_number');
        $event->start_date = $this->input->post('start_date');
        $event->end_date = $this->input->post('end_date');
        $event->time = $this->input->post('time');        
        $event->provider_id = $this->input->post('provider');
        $event->gmap = $this->input->post('gmap');
        $event->seo_url = $this->input->post('seo_url');
        $event->seo_summary = $this->input->post('se_summary');
        $event->seo_keywords = $this->input->post('se_keywords');
        $event->publish_date = $this->input->post('publish_date');
        $event->sending_date = $this->input->post('sending_date');
        $event->expiry_date = $this->input->post('expiry_date');
        $event->status = 1;
