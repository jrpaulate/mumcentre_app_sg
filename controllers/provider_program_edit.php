...
class provider_program_edit extends CI_Controller {
    ...
    function read($id){
        ...
        $this->bucket->set_content_id('cms/provider_program_edit');
...
//      $this->bucket->set_data('id_get', $response['id_get']);
    ...
    function update_program($id) {
        ...
        $program->scheduled_date = $this->input->post('scheduled_date');
