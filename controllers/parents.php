...
class Parents extends CI_Controller {
    ...
    function index(){
        ...
        $this->bucket->set_data('age_group', 5);
        $this->bucket->set_data('age_group_title', 'Parents');
        $this->bucket->set_data('age_group_link', 'parents');
        ...
        $this->bucket->set_data('title', 'Mumcentre - Parenting articles');
        $this->bucket->set_data('forum_group', 185);
        $this->bucket->set_data('og_image', '');
        $this->bucket->set_data('og_title', 'Mumcentre - Parenting articles');
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."parents");
    ...
    function read($url_title){
        ...
        $this->bucket->set_data('age_group', "Parents");
        ...
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."parents/".$url_title);
        $this->bucket->render_layout();
    }
...
//      return $dashed_summary;
    ...
    function parents_data() {
    echo '{"parents_data": [{'.$this->_latest_article().','.$this->_featured_articles().'}]}';
  }
