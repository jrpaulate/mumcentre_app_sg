...
class edit_curriculum extends CI_Controller {
...
//      $this->bucket->set_data('id_get', $response['id_get']);
    ...
    function update_curriculum($id) {
        ...
        $curriculum->seo_url = $this->input->post('seo_url');
        $curriculum->gmap = $this->input->post('gmap');
        $curriculum->seo_summary = $this->input->post('seo_summary');
        $curriculum->seo_keywords = $this->input->post('seo_keywords');
        ...
        $curriculum->contact_number = $this->input->post('contact_number');
