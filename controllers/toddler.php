...
class Toddler extends CI_Controller {
    ...
    function index(){
        ...
        $this->bucket->set_data('age_group', 3);
        $this->bucket->set_data('age_group_title', 'Toddler');
        $this->bucket->set_data('age_group_link', 'toddler');
        ...
        $this->bucket->set_data('title', 'Mumcentre - Toddler articles');
        $this->bucket->set_data('forum_group', 130);
        $this->bucket->set_data('og_image', '');
        $this->bucket->set_data('og_title', 'Mumcentre - Toddler articles');
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."toddler");
    ...
    function read($url_title){
        ...
        $this->bucket->set_data('age_group', "Toddler");
        ...
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."toddler/".$url_title);
        $this->bucket->render_layout();
    }
    ...
    function all(){
        ...
        $this->bucket->set_data('og_title', 'Mumcentre - Toddler articles');
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."toddler/all");
...
//      return $dashed_summary;
    ...
    function toddler_data() {
    echo '{"toddler_data": [{'.$this->_latest_article().','.$this->_featured_articles().'}]}';
  }
