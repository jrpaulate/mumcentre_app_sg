...
class Pregnancy extends CI_Controller {
    ...
    function index(){
        ...
        $this->bucket->set_data('age_group', 1);
        $this->bucket->set_data('age_group_title', 'Pregnancy');
        $this->bucket->set_data('age_group_link', 'pregnancy');
        ...
        $this->bucket->set_data('title', 'Mumcentre - Pregnancy articles');
        $this->bucket->set_data('forum_group', 128);
        $this->bucket->set_data('og_image', '');
        $this->bucket->set_data('og_title', 'Mumcentre - Pregnancy articles');
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."pregnancy");
    ...
    function all(){
        ...
        $this->bucket->set_data('og_title', 'Mumcentre - Pregnancy articles');
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."pregnancy/all");
    ...
    function read($url_title){
        ...
        $this->bucket->set_data('og_type', 'article');
        $this->bucket->set_data('og_url', $base."pregnancy/".$url_title);
        $this->bucket->render_layout();
    }
...
//      return $dashed_summary;
    ...
    function pregnancy_data() {
    echo '{"pregnancy_data": [{'.$this->_latest_article().','.$this->_featured_articles().'}]}';
  }
