...
<script type="text/javascript">
    $(document).ready(function(){
            ...
            $.get("partner_content_program/provider_data/"+ provider_id, function(response) {
        ...
        $("#upload").uploadify({
            ...
            'folder'        : 'mumcentre/uploaded/provider/program/image',
            ...
            'onComplete'   : function (event, queueID, fileObj, response, data) {
                $.post('<?php echo site_url('cms_program/uploadify'); ?>',{filearray: response},function(info){
        ...
        $('#create_program').click(function(e) {
            ...
            var program = tinyMCE.get('tadescription').getContent();
            ...
            if(title.length == 0) {
                ...
                $.post("cms_program/create_program", {
                    title: title,
                    avatar: avatar,
                    provider: provider,
                    summary: summary,
                ...
                function(data){
                    ...
                    if (code < 0) {
                        ...
                        alert(msg);
                        window.location = 'partner_content_program/read/<?php echo $id; ?>';
                    }
                });
            }
            e.preventDefault();
...
//        });
        ...
        $.get("cms_program/provider_list", function(response) {
            var data = JSON.parse(response);
            var template = ich.provider_listing_tpl(data);
...
<script type ="text/html" id="provider_listing_tpl">
 <table width="917" border="0" cellspacing="0" cellpadding="0">
   ...
   <span class="fontcomfortaa" style="font-size: 25px; color: #2490ce;">Add New Program </span> &nbsp;&nbsp;<img src="images/Header-Arrow.png">
...
<table width="917" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <div class="submenu">
    <div style="padding-top: 7px; text-align: center; height:28px; background-color:#2281b1; float:left; width: 106px; border-right: 2px solid #FFF; color:#000;"><a href="partner_content_program/read/<?php echo $id; ?>">Programs</a></div>
    </div>
    <div class="submenu">
...
<div style="border-bottom: 2px solid #2490ce; width: 917px;">
    ...
    <div class="event-form" align="center">
        ...
        <table width="917" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td align="right" class="fontcomfortaa2">Program Title:</td>
                <td></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="95"><a href="#" id="create_program" class="cssanchor"><img src="images/submit.png"></a></td>
                            <td width="474"><a href="partner_content_program/read/<?php echo $id; ?>"> <img src="images/CANCEL.png"></a></td>
                        </tr>
                    </table>
