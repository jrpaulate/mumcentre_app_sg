...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.get("partner_content_program/program_data/"+ provider_id, function(response) {
...
<table width="917" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="bord2">
    ...
    <td> <div id="program-listing"></div></td>
  </tr>
...
<script type ="text/html" id="provider_listing_tpl">
 <table width="917" border="0" cellspacing="0" cellpadding="0">
   ...
   <span style="font-size: 20px; color: #2490ce;">All Programs</span>
   <td align="right" class="mymenu"><a href="partner_content_program/add_program/<?php echo $id; ?>"><IMG src="images/btn-program.png"></a></td>
...
<script type="text/html" id="program_listing_tpl">
    <table width="917" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr class="bord2">
            ...
            <td ><span color="#ccc;"> {{program_title}} </td>
            <td ><span color="#ccc;"> {{program_status}} </td>
