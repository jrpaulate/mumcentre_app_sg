...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#upload").uploadify({
            ...
            'folder'        : '/mumcentre/uploaded/provider/review/image',
            ...
            'onComplete'   : function (event, queueID, fileObj, response, data) { 
                $.post('<?php echo site_url('partner_content_review/uploadify'); ?>',{filearray: response},function(info){
        ...
        $('#create_review').click(function(e) {                    
            ...
            var review = tinyMCE.get('tadescription').getContent();
            ...
            if(title.length == 0) {
                ...
                function(data){
                    ...
                    if (code < 0) {
                        ...
                        alert(msg);
                        window.location = 'partner_content_review/read/<?php echo $id; ?>';
                    } 
                });
            }
            e.preventDefault();
        ...
        $.get("cms_review/provider_list", function(response) {
            var data = JSON.parse(response);
            var template = ich.provider_listing_tpl(data);
...
<script type ="text/html" id="provider_listing_tpl">
 <table width="917" border="0" cellspacing="0" cellpadding="0">
   ...
   <span class="fontcomfortaa" style="font-size: 25px; color: #2490ce;">Add New Review </span> &nbsp;&nbsp;<img src="images/Header-Arrow.png">
...
<form id="frmMain" name="frmMain">
    ...
    <div class="event-form" align="center">
        ...
        <table width="917" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td align="right" class="fontcomfortaa2">Review Title:</td>
                <td></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="95"><a href="#" id="create_review" class="cssanchor"><img src="images/submit.png"></a></td>
                            <td width="474"><a href="partner_content_review/read/<?php echo $id; ?>"> <img src="images/CANCEL.png"></a></td>
                        </tr>
                    </table>
