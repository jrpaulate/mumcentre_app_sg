    ...
    $(document).ready(function(){
        ...
        $("#upload").uploadify({
            ...
            'onComplete'   : function (event, queueID, fileObj, response, data) { 
                $.post('<?php echo site_url('cms_review/uploadify'); ?>',{filearray: response},function(info){
    ...
    <div id="content">
        ...
        <div id="content-box">
            <div id="addnew-holder">
                ...
                <div id="articleinfo">
                    <p><i><font color="red">*</font> = Required Field</i></p>
                        ...
                        <dd><input type="text" name="geocoding" id="geocoding"/><input type="button" value="Get geocode" onclick="geo()">(Just leave this blank if there's no venue.)</dd>
                        <dt class="empty"></dt>
            ...
            <div class="clear floatright" style="margin-top:20px;">
                <div class="cssanchor"><a href="cms/cms_review" id="create_review" class="cssanchor">SUBMIT</a></div>
