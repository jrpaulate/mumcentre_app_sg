...
<script type="text/javascript">
  $(document).ready(function() {
    $('#submit_button').click(function(e) {
      ...
      $.post("cms_pow/categories_edit/" + postdata['id'], postdata, function(data) {
          if (data.code < 0) {
            alert(data.message);            
          } else {
            alert(data.message);
      ...
      <div id="addnew-holder">
        ...
        <div id="articleinfo">
          ...
          <dl>
            ...
            <dd>
              <input type="text" name="display_name" id="display_name" value="<?php echo $info['display_name']?>"/>
              <font color="red">*</font>
            </dd>
            <dt>
