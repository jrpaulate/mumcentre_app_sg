<div id="content">
 ...
 <!--
  ...
  <?php foreach ($data['category_all'] as $categ) :?>
    ...
    <?php else: ?>
      [<a href="cms_pow/contest_entries/<?php echo $categ['id'];?>"><?php echo $categ['display_name'];?> (<?php echo $categ['entrycount'];?>)</a>]     
    <?php endif;?>    
  <?php endforeach;?>
    ...
    <div id="article-listing">
      <table id="myTable" class="datatable" width="100%" cellpadding="0" cellspacing="0" border="0" >
        ...
        <tr>
          ...
          <td width="5%"><!-- TODO: Votes --></td>                  
          <td width="25%">
             <a class="actionbtn" href="pow/entry/<?php echo $row['token_id'];?>" target="_blank">View Entry</a> |             
             <a class="actionbtn" href="cms_pow/votes_details/<?php echo $row['id'];?>" id ="">View Detailed Votes </a> |             
