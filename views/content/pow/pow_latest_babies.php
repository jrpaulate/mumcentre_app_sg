				...
				<div id="pow-body-athan">
					<div id="pow-latest">
						<div class="img-wrapper">
							<img src="assets/img/system/sample-winner.jpg" alt="Photo Name" />
						</div><!-- .img-wrapper -->
						<div class="info-wrapper">
							...
							<div class="pow-desc lblue">
								<p>
									"Baby Cangeline on his first bed. Baby Cangeline on his first bed"
								</p>
							</div>
						</div><!-- .info-wrapper -->
						<div class="pow-share">
						...
						<div class="pow-past">
							...
							<ul class="entries-list">
								<li>
									<a href="#"><img src="assets/img/system/sample-winner.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-winner.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
					...
					<div id="pow-entries-past">
						...
						<div class="entries-past-body">
							<ul class="entries-list">
								<li>
									<a href="#"><img src="assets/img/system/sample-pic.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-dealday-small.jpg" alt="John Lou" title="John Lou"/><span>Min Ling Nam</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-winner.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-dealday-big.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-winner.jpg" alt="John Lou" title="John Lou"/><span>Lee Bag Kaba</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-pic.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								...
								<li>
									<a href="#"><img src="assets/img/system/sample-dealday-small.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-winner.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								...
								<li>
									<a href="#"><img src="assets/img/system/sample-ad1.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
								<li>
									<a href="#"><img src="assets/img/system/sample-pic.jpg" alt="John Lou" title="John Lou"/><span>John Lou</span></a>
								</li>
