		...
		<div id="content-main">
			...
			<div id="section-body">
				<div id="pow-body-athan">
					<div id="pow-latest">
					<?php if ( !empty($data['contest_info']) ) :?>  
						<?php render_partial('pow/pow_contestentries');?>
				  <?php else:?>
				    
				    There are no active contest or no entrys for voting yet. 
				    Please come back later or <?php echo anchor('pow/join/', 'Join the current Pick of the Week contest');?>
