							...
							<fieldset>
								<div style="text-align:center;">
									<p style="font-size: 18px;">
										<strong><?php echo $this->pow->options_get('message_successful_vote');?></strong>
									</p>
								</div>
							</fieldset>
						</div>
		...
		<div id="content-main">
			<div id="section-head">
				...
				<ul class="section-action">
					...
					<li>
						<a href="pow" title="Enter the Contest">Enter the Contest</a>
					</li>
					<li>
						<a href="pow/latest_winners" title="Past Entries/Winners">Past Entries/Winners</a>
					</li>
					<li>
						<a href="#" title="About POW">About POW</a>
					</li>
				</ul><!-- .section-action -->
				<ul class="section-subaction">
					<?php foreach ($data['entry_get_bytoken_list'] as $categ) :
					?>
					<li <?php echo $entry['pow_category_id'] == $categ['id'] ?  'class="selected"':'' ?>>
						<a href="pow/entries/<?php echo $categ['name']?>" title="<?php echo $categ['display_name']?>"><?php echo $categ['display_name']
						?></a>
					</li>
					<?php endforeach;?>
					<li>
						<a href="#" title="">Corp Sponsor</a>
					</li>
				...
				<div id="pow-body-athan">
					<div id="pow-latest">
						...
						<div>
							<div style="text-align:center;">
								<p style="font-size: 18px;">
									<strong>Your vote has been counted for this entry</strong>
								</p>
							</div>
						</div>
						<div class="pow-share">
							<ul class="fleft">
								<li>
									<a href="#"><img src="images/btn-twitter.png" alt="Twitter" /></a>
								</li>
								<li>
									<a href="#"><img src="images/btn-stumbleupon.png" alt="StumbleUpon" /></a>
								</li>
								<li>
									<a href="#"><img src="images/btn-email.png" alt="Email" /></a>
								</li>
								<li>
									<a href="#"><img src="images/btn-fblike.jpg" alt="Like Us" /></a>
								</li>
							</ul>
							<div class="fright">
								View all comments
