<div id="content">
  ...
  <div> 
  <a class="actionbtn btnconclude" href="cms_pow/contest_conclude/<?php echo $data['contest_info']['id'];?>" id="conclude<?php echo $data['contest_info']['id'];?>">
    Conclude this contest</a>
  </div>
  <br/>
  <?php foreach ($data['category_all'] as $categ) :?>
    ...
    <?php else: ?>
      [<a href="cms_pow/active_contest/<?php echo $data['contest_info']['id'];?>/<?php echo $categ['id'];?>"><?php echo $categ['display_name'];?> (<?php echo $categ['entrycount'];?>)</a>]     
    <?php endif;?>    
  <?php endforeach;?>
