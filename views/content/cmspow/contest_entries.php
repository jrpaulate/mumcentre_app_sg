<div id="content">
  ...
  ?><br/></h2>
  <span> [ Status <strong><?php echo strtoupper($data['contest_info']['status_name']);?></strong> ]
    [ Submission Period <strong><?php echo out_date($data['contest_info']['submission_start_date']);?>to <?php echo out_date($data['contest_info']['submission_end_date']);?></strong> ]
    [ Voting Period <strong><?php echo out_date($data['contest_info']['voting_start_date']);?>to <?php echo out_date($data['contest_info']['voting_end_date']);?></strong> ] </span>
  <br/>
  <br/>
      ...
      <div class="powcms-imglist">
        ...
        <div class="imgbox">
          ...
          <div class="imginfo">
            ...
            <table>
              <tr>
                <td class="imginfo-label">Age/Group</td><td><?php echo $data['contest_info']['age_group'];?></td>
              </tr>
              <tr>
              ...
              <?php if ($row['status'] == PENDING_ENTRY) : ?>
              <a class="actionbtn btnapprove" href="cms_pow/entry_approve/<?php echo $row['id'];?>"> Approve Entry </a> &nbsp; 
              <a class="actionbtn btnreject" href="cms_pow/entry_reject/<?php echo $row['id'];?>"> Reject Entry </a> &nbsp; 
              <?php endif;?>

              <?php if ($row['status'] == APPROVED_ENTRY) :?>
              <!-- <a class="actionbtn btnreject" href="cms_pow/entry_reject/<?php echo $row['id'];?>"> Reject Entry </a> &nbsp; -->
              <a class="actionbtn " href="cms_pow/entry_votes/<?php echo $row['id'];?>">View Votes</a> &nbsp; 
              <?php endif;?>

              <!-- <a class="actionbtn" href="cms_pow/entry_edit/<?php echo $row['id'];?>">Edit Entry</a> &nbsp; --> 
              <a class="actionbtn btndelete" href="cms_pow/entry_delete/<?php echo $row['id'];?>">Delete Entry</a> &nbsp;                   
